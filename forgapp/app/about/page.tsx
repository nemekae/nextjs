    ...
    <main>
            <section className="container max-w-4xl px-4 py-8 mx-auto">
                ...
                <div className="grid items-center gap-8 mb-12 md:grid-cols-2">
                    <div className="relative h-[300px] w-full">
                        <Image  
                            src="/hero-image.png"
                            alt="ForgApp Community - A group of makers collaborating on 3D printing projects"
                            width="350"
                            height="300"
                        />
                    </div>
                    <div>
                        ...
                        <p className="mb-4 text-gray-700">
                            Founded in 2023, ForgApp has quickly become the
            ...
            <section className="container max-w-3xl px-4 py-8 mx-auto">
                <div className="prose max-w-none">
                    ...
                    <p className="mb-4 text-gray-700">
                        At ForgApp, we believe that 3D printing is
                    ...
                    <p className="text-gray-700">
                        ...
                        ForgApp provides the tools and community to support
